...
import {accent, lightPrimary, primaryText, secondaryText, baseText} from "./BaseStyle"
...
function RegSuccess() {
  return (
        <Container>
            ...
            <SeparatorLine/>
            <ContainerDownHalf>
            <H3Name>Заполните данные в профиле, чтобы бронировать и совершать покупки!</H3Name>
            </ContainerDownHalf>
        </Container>    
  )
}
