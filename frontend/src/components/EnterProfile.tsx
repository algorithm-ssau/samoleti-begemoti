        ...
        <Container>
            ...
            <ContainerDownHalf>
                ...
                <ContainerDownRight>
                    ...
                    <Passward placeholder='пароль' type='password' id='password'/>
                    <input type='checkbox' id='check' onClick={ShowPassword}/>Показать
                </ContainerDownRight>
                </ContainerDownHalf>
                <ContainerDownLow>
                ...
                <ContainerDownLow>
                    <WhiteButton2 onClick={RegistrButton}>Зарегистрироваться</WhiteButton2>
                </ContainerDownLow>
        </Container>    
  )
}
